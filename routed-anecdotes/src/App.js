...
const App = () => {
  ...
  const matchRoute = useRouteMatch('/anecdotes/:id')
  let anecdote  

  if(matchRoute) {
	
	
    anecdote= anecdotes.find(anecdote => anecdote.id === matchRoute.params.id)
    ...
    <div>
      <h1>Software anecdotes</h1>
        ...
        <Route path="/anecdotes/:id">
          ...
          <Route path="/">    
            {
              notification !== '' ? setTimeout(() => {setNotification('')}, 10000) : null  
